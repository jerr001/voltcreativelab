      ...
      {selectedImage && (
        ...
        >
          ...
          >
            ...
            <button
              onClick={closeLightbox}
              className="absolute -top-10 right-0 text-white hover:text-[var(--gold)] transition-all duration-300 text-2xl font-bold hover:scale-125"
            ...
            {images.length > 1 && (
              <>
                <button
                  onClick={prevImage}
                  className="absolute left-4 top-1/2 -translate-y-1/2 bg-[var(--gold)] hover:bg-[var(--accent)] text-white rounded-full w-10 h-10 flex items-center justify-center transition-all duration-300 shadow-lg hover:shadow-2xl hover:scale-110"
                ...
                <button
                  onClick={nextImage}
                  className="absolute right-4 top-1/2 -translate-y-1/2 bg-[var(--gold)] hover:bg-[var(--accent)] text-white rounded-full w-10 h-10 flex items-center justify-center transition-all duration-300 shadow-lg hover:shadow-2xl hover:scale-110"
