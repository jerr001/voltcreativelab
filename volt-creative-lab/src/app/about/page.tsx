    ...
    <main>
      ...
      <section className="max-w-5xl mx-auto py-16 px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          {/* Vision Card */}
          <div className="bg-[var(--surface)] rounded-2xl shadow-lg p-8 flex flex-col items-center text-center text-[var(--dark-blue)] animate-hero-fadein animate-slide-up-fade transition-all duration-300 ease-out transform hover:scale-105 hover:shadow-2xl hover:-translate-y-3">
          ...
          {/* Mission Card */}
          <div className="bg-[var(--surface)] rounded-2xl shadow-lg p-8 flex flex-col items-center text-center text-[var(--dark-blue)] animate-hero-fadein animate-slide-up-fade delay-150 transition-all duration-300 ease-out transform hover:scale-105 hover:shadow-2xl hover:-translate-y-3">
            <h2 className="text-xl font-bold mb-2 text-[#a259ff]">
              Our Mission
            </h2>
            <p className="text-base opacity-90">
          ...
          {/* Values Card */}
          <div className="bg-[var(--surface)] rounded-2xl shadow-lg p-8 flex flex-col items-center text-center text-[var(--dark-blue)] animate-hero-fadein animate-slide-up-fade delay-300 transition-all duration-300 ease-out transform hover:scale-105 hover:shadow-2xl hover:-translate-y-3">
            <h2 className="text-xl font-bold mb-2 text-[#a259ff]">
              Core Values
            </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          {/* What We Do Card */}
          <div className="bg-[var(--surface)] rounded-2xl shadow-lg p-8 text-[var(--dark-blue)] animate-hero-fadein animate-slide-up-fade transition-all duration-300 ease-out transform hover:scale-105 hover:shadow-2xl hover:-translate-y-3">
          ...
          {/* Sub-Brands Card */}
          <div className="bg-[var(--surface)] rounded-2xl shadow-lg p-8 text-[var(--dark-blue)] animate-hero-fadein animate-slide-up-fade delay-150 transition-all duration-300 ease-out transform hover:scale-105 hover:shadow-2xl hover:-translate-y-3">
            <h2 className="text-xl font-bold mb-4 text-[#a259ff]">
              Our Sub-Brands
            </h2>
            <ul className="list-disc pl-5 space-y-1 opacity-90">
